"""
Groq Provider — Ultra-fast inference for NetClaw Battles.

Groq offers ~200ms latency which gives a competitive edge
in timed Battle responses.
"""
...
logger = logging.getLogger("netclaw.provider.groq")


class GroqProvider(BaseLLMProvider):
    """Groq API provider using their REST endpoint."""
